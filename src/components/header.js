      ...
      <header data-thq="thq-navbar" className="header-navbar-interactive">
        ...
        <div className="header-container2">
          <nav className="header-links">
            ...
            <Link to="/teenused" className="header-main1">
              <span className="header-text">Teenused</span>
              <br className=""></br>
            </Link>
            <Link to="/meist" className="header-about-us">
              {props.About_us}
            </Link>
            <Link to="/kontakt" className="header-contact">
              {props.Contact}
            </Link>
          </nav>
        </div>
