    ...
    <div className="teenused-container">
      ...
      <div className="teenused-header">
        ...
        <header data-thq="thq-navbar" className="teenused-navbar-interactive">
          ...
          <div data-thq="thq-mobile-menu" className="teenused-mobile-menu">
            <div className="teenused-nav">
              <div className="teenused-top">
                <span className="teenused-logo">3DPRINT</span>
                <div data-thq="thq-close-menu" className="teenused-close-menu">
                  <svg viewBox="0 0 1024 1024" className="teenused-icon02">
                    <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
                  </svg>
                </div>
              </div>
              <nav className="teenused-links1">
                <span className="teenused-nav1">Main</span>
                <span className="teenused-nav2">About Us</span>
                <span className="teenused-nav3">Contact</span>
                <span className="teenused-nav4">Team</span>
                <span className="teenused-nav5">Blog</span>
              </nav>
              <div className="teenused-buttons">
                <button className="teenused-login button">Login</button>
                <button className="teenused-register button">Register</button>
              </div>
            </div>
            <div>
              <svg
                viewBox="0 0 950.8571428571428 1024"
                className="teenused-icon04"
              >
